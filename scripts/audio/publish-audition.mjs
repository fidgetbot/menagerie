...
function renderAuditionPage(manifest) {
  const currentReferences = [
    {
      label: "Current muted stoneware A",
      detail: "Seed 216001 · shipped bank",
      src: "../ceramic/stoneware_contact__seed-216001.wav",
    },
    {
      label: "Current muted stoneware B",
      detail: "Seed 216003 · shipped bank",
      src: "../ceramic/stoneware_contact__seed-216003.wav",
    },
  ];
...
<body><main>
  ...
  <div class="notice"><strong>Muted stoneware is now the live gameplay bank.</strong> The other material families remain audition previews only. Untouched stereo masters remain in the local generation archive.</div>
  <section data-group>
