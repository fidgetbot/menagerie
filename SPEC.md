...
Initial agreed design. Implementation, asset generation, simulation tuning, and deployment have not started. Technical parameters below are prototype targets, not validated results.
